...
Documentos legais de **Launchline** (`com.uaigames.launchline`) — publicados via GitHub Pages.
...
2. A URL fica `https://caixeta94.github.io/Launchline-Legal/`

## URLs para a ficha da Play Store

| Campo do Play Console | URL |
|---|---|
| Política de Privacidade | `https://caixeta94.github.io/Launchline-Legal/privacidade.html` |
| Exclusão de conta (Data safety) | `https://caixeta94.github.io/Launchline-Legal/exclusao-de-conta.html` |
| Site do desenvolvedor | `https://caixeta94.github.io/Launchline-Legal/` |
...
- [ ] Os flags de feature em `games.json` batem com o que o app **realmente faz**
      (hoje: `leaderboard, replay, ghost, async_duel, cloud_save, seasons, analytics, ads, ads_so_premiado, ads_ssv`). Data Safety divergente do comportamento real é a causa
